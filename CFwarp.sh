...
yellow "当前WARP(+)为--临时关闭--状态，现执行:恢复开启……"
sleep 1s
...
white " 经检测，你的VPS原生IP类型：双栈IPV6+IPV4"
...
blue " 切记：进入脚本快捷方式 bash CFwarp.sh "
white " ==================一、VPS相关调整选择（更新中）==========================================" 
white "  1. 开启甲骨文VPS的系统所有端口 "
white "  2. 更新5.6以下系统内核至5.6以上 "
white "  3. 开启原生BBR加速 "
white "  4. 检测奈飞Netflix是否解锁 "
white " ==================二、WARP功能选择（更新中）==============================================="
green " 经检测，你的VPS原生IP类型：纯IPV4"
green " 以下（5.6.7）三个方案可随意切换安装"
white "  5. 添加WARP虚拟IPV4，     IP出站流量表现为：IPV4由WARP接管，无IPV6，不支持IP分流               "
white "  6. 添加WARP虚拟IPV6，     IP出站流量表现为：IPV4为原生，IPV6由WARP接管，支持IP分流    "
white "  7. 添加WARP虚拟IPV4+IPV6，IP出站流量表现为：IPV6与IPV4都由WARP接管，支持IP分流           "
white " ---------------------------------------------------------------------------------"
white "  8. 无限刷取WARP+PLUS账户流量 "
white "  9. 手动无限刷新WARP的IP"    
white " 10. 开启或关闭WARP功能 "
white " 11. 彻底卸载WARP功能 "
white " ==================三、代理协议脚本选择（更新中）==========================================="
white " 12.使用mack-a脚本（支持Xray, V2ray） "
white " ============================================================================================="
white " 0. 退出脚本 "
Print_ALL_Status_menu
echo
